...
void print_var_values(BmiDhsvm model, const char *var_name);
void print_var_column(BmiDhsvm model, const char *var_name, int colno);
...
void
print_var_column(BmiDhsvm model, const char *name, int colno)
{
  int grid;
  int * shape;
  int rank;
...
void
print_var_values(BmiDhsvm model, const char *var_name)
{
  double *var = NULL;
  int i, j;
  int grid;
