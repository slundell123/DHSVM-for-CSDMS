...
int main(int argc, char *argv[])
{
  ...
  if (argc != 2) {
    printf("Usage: run_bmidhsvmcxx CONFIGURATION_FILE\n\n");
    printf("Run the dhsvmcxx model through its BMI with a configuration file.\n");
    printf("Output is written to the file `bmidhsvmcxx.out`.\n");
    return bmi::BMI_SUCCESS;
  }

  FILE *fp = fopen("bmidhsvmcxx.out", "w");
